...
String directoryPath = ProExternalStorage.getWriteableDirectory(context, ProExternalStorage.DirectoryType.NULL, dirName);
...
ProExternalStorage.onForceDelete(directoryPath);
```